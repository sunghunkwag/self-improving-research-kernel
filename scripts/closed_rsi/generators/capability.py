...
def build_self_proposed_operator_test(
    ...
    *,
    ...
    cases = [
        case
        for case in self_proposed_dynamic_hidden_cases(seed, residues)
...
def self_proposed_capability_candidates(
    ...
    *,
    ...
    for dimension in propose_capability_dimensions_from_residue(residues, seed=seed):
        if f"def {dimension.operator}(" in text:
            continue
        ...
        candidates.append(
            CandidatePatch(
                ...
                test_source=build_self_proposed_operator_test(dimension, seed=seed, residues=residues),
