...
def test_classify_residue_feedback_policy_surface_generator_feedback_polic_runtimeerror_pressure_hidden_transfer_1():
    ...
    assert classify_residue_feedback_policy_surface_generator_feedback_polic_runtimeerror_pressure(payload) == {'family': 'residue_feedback_policy_surface_generator_feedback_polic_runtimeerror', 'dominant_signal': 'feedback_policy_surface', 'pressure': 5, 'needs_hidden_transfer': True, 'difficulty': 1, 'evidence_width': 6}
